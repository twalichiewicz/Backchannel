...
- **The article opens beside its discussion.** It loads in a frame, with
  ...
  on any page: pressing a highlight focuses the discussion on it, and pressing
  a quote scrolls the article to its passage. A site that refuses to be framed
  is read out instead, as a plain reading view in the panel's colors, and a page
...
- **The wheel scrolls the stories on backchnnl.app.** It did nothing while the
